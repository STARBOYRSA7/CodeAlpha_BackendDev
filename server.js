...
app.get('/api/events', (req, res) => res.json(task2Db.get('events').value()));
...
// ═══════════════════════════════════════════════════════
// ── 3. TASK 3: RESTAURANT MANAGEMENT ──────────────────
// ═══════════════════════════════════════════════════════
